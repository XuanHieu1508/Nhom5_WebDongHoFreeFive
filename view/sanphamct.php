...
<div class="product-images relative mb-half has-hover woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images" data-columns="4">
  ...
  <figure class="woocommerce-product-gallery__wrapper product-gallery-slider slider slider-nav-small mb-half"
        data-flickity-options='{
				...
				$hinh = $img_path . $img;
                    echo '
    <div class="woocommerce-product-gallery__image slide first"><img width="600" height="600" src="' . $hinh . '" class="wp-post-image skip-lazy" alt="" data-large_image="" data-large_image_width="1024" data-large_image_height="1024" sizes="(max-width: 600px) 100vw, 600px" /></a></div> </figure>
...
<nav class="woocommerce-breadcrumb breadcrumbs uppercase"><a href="./index.php">Trang chủ</a> 	<h1 class="product-title product_title entry-title">
	' . $namesp . '</h1>
...
<ul class="next-prev-thumbs is-small show-for-medium">         <li class="prod-dropdown has-dropdown">
              ...
              <div class="nav-dropdown">
                ...
                <img width="100" height="100" src="../wp-content/uploads/2019/12/dong-ho-mvmt-magnolia-2-master-100x100.jpg" class="attachment-woocommerce_gallery_thumbnail size-woocommerce_gallery_thumbnail wp-post-image" alt=""  sizes="(max-width: 100px) 100vw, 100px" /></a>
              </div>
          </li>
